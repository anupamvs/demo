            ...
            <form class="col s12">
                <div class="row">
                    ...
                    <div class="input-field col s12" style="margin-top: 0px;">
                        <p class="orange-text" style="margin-top: 0px;">Add Images</p>
                        <img src="assets/images/pothole.jpeg" class="thumbnail">
                        <img src="assets/images/pothole.jpeg" class="thumbnail">
                        <img src="assets/images/pothole.jpeg" class="thumbnail">
                        <img src="assets/images/camera.png" class="thumbnail">
                    </div>
                    <div class="input-field col s12">
